...
const styles = StyleSheet.create({
  ...
  muted: { color: '#888' },
  muted2: { color: '#4f6f8d', fontSize: 12, marginBottom: 12 },
  card: { marginBottom: 8, backgroundColor: '#f5faff' },
  t: { fontSize: 16, fontWeight: '600' },
  stage: { marginBottom: 10, backgroundColor: '#fff' },
  payCenter: { marginBottom: 12, backgroundColor: '#f5faff', borderColor: '#ffd7c5' },
